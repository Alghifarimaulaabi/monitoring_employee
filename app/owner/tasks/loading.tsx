export default function OwnerTasksLoading() {
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="h-10 w-36 bg-rose-200 rounded-xl shrink-0" />
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200/80 shadow-xs p-6 space-y-3">
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            key={i}
            className="p-4 rounded-xl border border-gray-100 bg-gray-50/50 flex items-center justify-between gap-4"
          >
